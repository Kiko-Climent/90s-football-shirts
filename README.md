...
## Showcase
![Am i Responsive](media/readme_media/responsive.png)
...
* As a _Site User_ I can have _a quick search by prices,_ so _I can easily find products within my budget_
* As a _Site User_ I can have a quick search by ratings so that _I can easily find highly-rated products._ 
...
***Site Admin***
* As a _Site Admin_ I can _be able to add new products_ so that _i can create new content in the site_
* As a _Site Admin_ I can _update products in the site_ so that _i can edit any possible change_
...
***Site Admin***
* As a _Site Admin_ I can _see a detailed list of orders_ so that _im aware about all the purchases from users_
...
90's Football Shirts operates as a B2C business, functioning as a digital online store where users can purchase retro sports kits. The primary objective for the administrator is to successfully implement CRUD functionality.

## Marketng

90's football shirts has decided to use social media marketing as the main technique in the development and spread of the content on the page. The social network _Facebook_ was chosen to implement this technique. You can visit the profile [Here](https://www.facebook.com/profile.php?id=61556575044215)

Email marketing was also used to create engagement with new users of the page; in this case, we opted for _Mailchimp_ as the tool.
...
![Header](media/readme_media/logo_header_nav.png)

### Home Image and Call-to-Action:
![Call-to-Action](media/readme_media/home_img_call_action.png)
...
![Footer](media/readme_media/footer.png)
![Privacy Policy](/media/readme_media/privacy_policy.png)
...
![All Products](media/readme_media/category_all_products.png)
![Clubs](media/readme_media/category_clubs.png)
![National Teams](media/readme_media/category_national.png)
![Brands](media/readme_media/category_brands.png)

- Sorted by Price:
![Sorted by Price](media/readme_media/sorted_price.png)

- Sorted by Ratings:
![Sorted by Ratings](media/readme_media/sorted_ratings.png)
...
![Sign Up](media/readme_media/sign_up.png)
...
![Log In](media/readme_media/log_in_page.png)

### Log In Success:
![](media/readme_media/log_in_success.png)

### Log Out:
![Log Out](media/readme_media/log_out.png)
...
![Products](media/readme_media/all_products_page.png)
...
![Product Detail Page](media/readme_media/product_detail.png)

### Product Detail Info:
![Product Description](media/readme_media/product_detail_info.png)

## Rating:
Upon clicking the _Ratings_ icon, the user will be shown a dropdown menu where they can enter their own rating

![Rating](media/readme_media/rating.png)
...
![Wishlist](media/readme_media/wishlist.png)
...
![Shopping Cart](media/readme_media/shopping_cart.png)
...
![Costs Resume](media/readme_media/amount_with_discount.png)
...
![Checkout](media/readme_media/purchase.png)
![Shipping Details](media/readme_media/shipping_details.png)
![Resume](media/readme_media/products_resume.png)
![Payment Information](media/readme_media/payment_information.png)
...
![Checkout Success](media/readme_media/purchase_success.png)
![Purchase confirmation email](media/readme_media/order_confirmation_email.png)
...
![Profile](/media/readme_media/users_profile.png)

Clicking on any of the past orders redirects us to the "Purchase Success" page for that specific order, with a message informing the user

![Past Orders](media/readme_media/past_orders.png)
...
![Contact](/media/readme_media/contact_form.png)
...
![Contact Success](/media/readme_media/contact_success.png)
![Contact Confirmation Email](/media/readme_media/contact_confirmation_email.png)
...
In the _Accounts_ icon, only the authenticated administrator will see a link labeled _Management,_ which will redirect them to the page for uploading new products to the store.
...
![Add New Product](/media/readme_media/add_product.png)
...
![Delete Product](/media/readme_media/delete_product.png)
![Edit Product](/media/readme_media/edit_product.png)
![](media/readme_media/all_products_management.png)

### 404 Error:

![404](media/readme_media/404_error.png)


### Future Implementations
The project was initially created with the possibility that items without sizes would also be accommodated. Products like retro-style scarves or caps are some things that could be implemented on the site in the future.

A _Blog_ section was also highly present in the project's development. A place where retro football enthusiasts could discuss great moments in football history, iconic players, unforgettable goals, and legendary matches. Undoubtedly, it would be a great addition to the site.

It could also be implemented a functionality where the user, in addition to being able to leave the rating, could provide _feedback_ after experiencing a purchase, for example. This would enhance the user experience.

# Web Marketing

## Email Marketing:
_Mailchimp_ was used in order to implement a Web marketing strategy. Users can find the registration form located inside the footer and just by entering the email adress they will be automatically subscribed to the Monthly newsletter.

![Newsletter](media/readme_media/newsletter.png)

## Search Engine Optimization:
SEO words selected as keywords:

![Meta Tags](/media/readme_media/meta_tags.png)
![Wordtracker](/media/readme_media/wordtracker.png)
![Wordtracker](/media/readme_media/wordtracker2.png)

Apparently, Wordtracker has changed its configuration, and unfortunately, I was only able to perform one search, and another one in incognito mode.

## Social Media:
_Facebook_ was used as plattform to develope the _Social media marketing_. Due to the simplicity and scope i thought it would be the best tool to implement it the social media strategy.

![Facebook](media/readme_media/facebook.png)
![Facebook/1st Post](media/readme_media/facebook2.png)
![Facebook/2nd Post](media/readme_media/facebook3.png)
